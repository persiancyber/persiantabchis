...
local botcli = 223216214
local SUDO = 223216214
local BOT = 1
...
--------Close-------#mehran
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = 'persian cyber ⇜', url = 'https://t.me/etehad_arazel'}
				}
							}
...
-------------------
    ...
    keyboard.inline_keyboard = {
         {
				 {text = '• کانال ما', url = 'https://t.me/etehad_arazel'}
                },{
                   {text = '• نویسنده سورس', url = 'https://t.me/persiancyber1'}
				   }
							}
